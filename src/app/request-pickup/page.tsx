        ...
        >
          <div className="max-w-3xl">
            ...
            >
              <a
                href="tel:0726947844"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#67c98b] px-6 py-3.5 text-sm font-bold text-[#122019] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-lg"
              >
                <Phone size={17} />
                Call 0726 947 844
              </a>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 px-6 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-white/10"
              >
