        ...
        <section className="relative overflow-hidden bg-[#122019] px-6 py-24 text-white lg:px-8 lg:py-32">
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                >
                    ...
                    >
                        From regular garbage collection to garbage
                        polythene sales, Baraka Garbage Services provides
                        practical solutions for cleaner homes and
                        businesses.
                    </motion.p>
            ...
            <div className="mx-auto max-w-7xl">
                ...
                >
                    ...
                    <h2 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                        Services designed around your everyday needs.
                    </h2>

                    <p className="mt-5 leading-7 text-gray-600">
                        Choose the service you need and get in touch with us
                        to arrange collection or make a purchase.
                    </p>
                </motion.div>
                    ...
                    {services.map((service) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative overflow-hidden rounded-[2rem] border border-[#176b3a]/10 bg-gradient-to-br from-[#e7f2e9] via-[#f2f8f3] to-[#dcecdf] p-8 shadow-sm transition-shadow duration-500 hover:shadow-2xl hover:shadow-[#176b3a]/10 sm:p-10"
                            >
                                ...
                                {/* Number */}
                                <div className="absolute right-7 top-4 text-7xl font-black text-[#176b3a]/10 transition-all duration-500 group-hover:scale-110 group-hover:text-[#176b3a]/15">
                                    {service.number}
                                </div>
        ...
        <section className="relative overflow-hidden bg-[#122019] px-6 py-20 text-white lg:px-8 lg:py-24">
            ...
            >
                ...
                <p className="mx-auto mt-5 max-w-xl leading-7 text-white/60">
                    Contact Baraka Garbage Services to arrange a garbage
                    collection or enquire about our garbage polythene
                    products.
                </p>
